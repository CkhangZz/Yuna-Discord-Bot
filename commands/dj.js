  ...
  run: async (client, interaction) => {
    ...
    try {
      ...
      if (stp === "set") {
        ...
        return await interaction.reply({ content: lang.msg25.replace("{role}", role.id), flags: 64 }).catch(e => { });
      ...
      if (stp === "reset") {
        ...
        if (data?.role) {
          ...
          return await interaction.reply({ content: lang.msg27, flags: 64 }).catch(e => { });
        } else {
          return await interaction.reply({ content: lang.msg28, flags: 64 }).catch(e => { });
        }
      }
